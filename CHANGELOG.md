...
- *Small Breaking Change* Improve ASTraitCollection availability annotations and removed public factory methods. If you use them, which you really aren't intended to, then migrate to `+traitCollectionWithASPrimitiveTraitCollection:`. Good news: This fixes a ton of unguarded availability warnings! [Adlai Holler](https://github.com/Adlai-Holler)
